...
- body: DEEL 1 — SAMENVATTING VAN DE ANALYSE van het huidige tabblad (3-5 zinnen, max 90 woorden). Analyseer het thema van het tabblad (Overview = gezamenlijke analyse over alle domeinen). Beschrijf de huidige stand concreet met de getallen uit DATA als cijfers — uitsluitend exacte waarden uit DATA, reken niet zelf en voeg geen inkomen toe aan saldo's. Geen uitgeschreven getallen
