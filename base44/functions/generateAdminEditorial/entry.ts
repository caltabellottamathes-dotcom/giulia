...
- items: 1-3 ACTIEPUNTEN. Elk object heeft: n ("01"), title (korte titel), desc (1 concrete zin met uitleg: welke wallet, welk bedrag, waarom — cijfers als cijfers, niet enkel "Saldo aanvullen" of "Overboeking"), action_type, amount, from_id, to_id, expense_id. Vul ALTIJD desc in met de uitleg. from_id, to_id, expense_id zijn exacte ID-strings uit de data of "" — nooit zinnen of redenering. action_type ∈ "transfer" (verplaats amount van from_id wallet naar to_id wallet), "pay" (voer expense_id uit / betaal), "reserve" (verplaats amount van from_id naar to_id om te reserveren), "none" (informatief, geen auto-actie). Gebruik de ECHTE wallet-ID's uit de data voor from_id/to_id en de echte expense-ID voor expense_id. Zonder bruikbare ID's → action_type "none"
