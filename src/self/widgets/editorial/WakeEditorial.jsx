...
/** Wake — standaardglas + zwevende foto-kaart bovenaan. Verticale fase-ladder. */
export default function WakeEditorial() {
  ...
  return (
    <WidgetShell size="1x2" radius="large" interactive onClick={() => openModule("selfwake")} className="min-h-[340px] sm:row-span-2" style={{ "--tile-accent": CONTRAST, overflow: "visible" }}>
      ...
      <FloatPhoto src={SELF_PHOTO.wake} stick="top" overlay="linear-gradient(180deg, rgba(48,23,40,0.10), rgba(48,23,40,0.55))">
        <div className="absolute inset-0 flex items-center justify-between px-4">
          <p className="text-[9px] uppercase tracking-[0.2em] text-ivory/75 font-semibold">drempel · ochtend</p>
