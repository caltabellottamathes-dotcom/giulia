...
/** Personal Development — standaardglas + zwevende foto-kaart links.
...
export default function PersonalDevelopmentEditorial() {
  ...
  return (
    <WidgetShell size="2x2" radius="large" interactive onClick={() => openModule("selfdevelopment")} className="min-h-[300px] sm:col-span-2 sm:row-span-2" style={{ "--tile-accent": CONTRAST, overflow: "visible" }}>
      <div className="relative z-10 h-full p-5 pl-28 flex flex-col text-ivory">
      ...
      <FloatPhoto src={SELF_PHOTO.development} stick="left" overlay="linear-gradient(90deg, rgba(48,23,40,0.62), rgba(48,23,40,0.05) 60%)">
        <div className="absolute inset-0 flex flex-col items-center justify-between py-3">
          <p className="text-[8px] uppercase tracking-[0.2em] text-ivory/70 font-semibold [writing-mode:vertical-rl]">groei</p>
