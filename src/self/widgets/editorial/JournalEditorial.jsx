...
/** Journal — glas OVER foto (foto onder, volle breedte, groter). Verticale
 *  draad met highlight-sterren. */
export default function JournalEditorial() {
  ...
  return (
    <WidgetShell size="1x2" radius="large" interactive onClick={() => openModule("selfjournal")} className="min-h-[340px] sm:row-span-2" style={{ "--tile-accent": PLUM, overflow: "visible", background: "transparent" }}>
      <FloatPhoto src={SELF_PHOTO.journal} edge="bottom" size="h-32" className="z-0" />
      <div className="relative z-10 h-full p-5 pb-24 glass-2 rounded-[inherit] flex flex-col" style={{ color: PLUM }}>
