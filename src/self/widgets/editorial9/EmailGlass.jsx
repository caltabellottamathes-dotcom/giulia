...
/** EmailGlass — glas-groot + foto-klein: ongelezen-teller + categoriebalk. · 16:9 */
export default function EmailGlass() {
  ...
  return (
    <GlassPhotoCard photo={PHOTO} onClick={() => openModule("email")} aspectRatio="16 / 9" photoSide="right"
      top={<><p className="text-[10px] uppercase tracking-[0.24em] font-bold opacity-70">Online Postoffice.</p><h3 className="text-[28px] leading-[0.86] font-display font-semibold tracking-[-0.04em] mt-0.5">POST</h3></>}>
