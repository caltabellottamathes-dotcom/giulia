...
/** SocialGlass — glas-groot + foto-klein: interactie-teller + 8-weekse balken. · 3:2 */
export default function SocialGlass() {
  ...
  return (
    <GlassPhotoCard photo={PHOTO} onClick={() => openModule("social")} aspectRatio="3 / 2" photoSide="right"
      top={<><p className="text-[10px] uppercase tracking-[0.24em] font-bold opacity-70">What Social Life?</p><h3 className="text-[30px] leading-[0.86] font-display font-semibold tracking-[-0.04em] mt-0.5">SOCIAL</h3></>}>
      <div className="flex items-end gap-3 mb-2">
        <span className="text-[36px] font-display font-semibold tabular-nums leading-none" style={{ color: BURG }}>{total}</span>
