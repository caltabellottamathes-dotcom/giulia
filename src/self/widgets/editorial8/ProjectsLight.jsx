...
/** ProjectsLight — grote foto + zacht glas met actieve count + zachte voortgangsbalken. · 4:3 */
export default function ProjectsLight() {
  ...
  return (
    <PhotoCardLight photo={PHOTO} onClick={() => openModule("projects")} aspectRatio="4 / 3"
      top={<><p className="text-[10px] uppercase tracking-[0.24em] font-bold opacity-70">What I'm Building.</p><h3 className="text-[32px] leading-[0.84] font-display font-semibold tracking-[-0.04em] mt-0.5">BOUWEN</h3></>}>
      <div className="flex items-end gap-3 mb-3">
        <span className="text-[38px] font-display font-semibold tabular-nums leading-none" style={{ color: BURG }}>{active.length}</span>
