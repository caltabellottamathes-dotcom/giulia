...
/** PeopleLight — grote foto + zacht glas met over-datum-teller + top 3. · 3:4 */
export default function PeopleLight() {
  ...
  return (
    <PhotoCardLight photo={PHOTO} onClick={() => openModule("people")} aspectRatio="3 / 4"
      top={<><p className="text-[10px] uppercase tracking-[0.24em] font-bold opacity-70">People Around Me.</p><h3 className="text-[32px] leading-[0.84] font-display font-semibold tracking-[-0.04em] mt-0.5">MENSEN</h3></>}>
      <div className="flex items-end gap-3 mb-3">
        <span className="text-[44px] font-display font-semibold tabular-nums leading-none" style={{ color: BURG }}>{overdue.length}</span>
