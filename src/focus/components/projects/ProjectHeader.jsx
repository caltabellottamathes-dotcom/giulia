...
import { InlineText, InlineDate } from "@/focus/components/projects/InlineEdit";
...
export default function ProjectHeader({ project, onUpdate, onEdit, onDelete, onBack }) {
  ...
  return (
    <div
      ...
      className="overflow-hidden float-shadow fixed top-0 left-0 right-0 z-0 rounded-none lg:left-10 lg:right-10 lg:rounded-[24px]"
    >
