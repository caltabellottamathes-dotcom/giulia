 ...
 *  volle hoogte), volledig in beeld. */
const MODULE_KEY = "tasks";
const ACCENT = "hsl(var(--charcoal))";   // MODULE_ACCENT.tasks
const TOPIC = "Wat nu op je ligt";         // MODULE_TOPIC.tasks
const ROUTE = "/tasks";                    // MODULE_ROUTE.tasks
