...
const GROUPS = [
  {
    ...
    items: [
      ...
      { label: "Waiting on You.", route: "/approvals", module: "approvals" },
      { label: "Briefing", route: "/briefing" },
      { label: "What I've Noticed.", route: "/insights", module: "insights" },
      { label: "Meanwhile...", route: "/updates", module: "updates" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "What's Happening?", route: "/agenda", module: "agenda" },
      { label: "What Social Life?", route: "/life/social", module: "social" },
      { label: "Reminders For Home.", route: "/life/household", module: "household" },
      { label: "Things to Handle!", route: "/life/personal-admin", module: "personaladmin" },
      { label: "Things I Love.", route: "/life/hobbies", module: "hobbies" },
      { label: "Becoming Me.", route: "/life/development", module: "development" },
      { label: "How I'm Doing.", route: "/life/daily-state", module: "dailystate" },
    ],
  },
  {
    label: "System",
    items: [
      ...
      { label: "What I Remember.", route: "/memory", module: "memory" },
      { label: "I Do Process!", route: "/activity", module: "activity" },
      { label: "Who's Working?", route: "/agents", module: "agents" },
      { label: "What I Know.", route: "/knowledge", module: "knowledge" },
