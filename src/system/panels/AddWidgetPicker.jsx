...
const DOMAINS = [
  ...
  { key: "focus", label: "FOCUS", accent: "hsl(var(--d-focus-deep))" },
  { key: "life", label: "LIFE", accent: "hsl(var(--ridge))" },
      ...
      <div className="p-5 text-ivory">
        ...
        <div className="grid grid-cols-3 gap-2.5">
          <AnimatePresence mode="wait">
            <motion.div key={domain} initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -6 }} transition={{ duration: 0.2 }} className="col-span-3 grid grid-cols-3 gap-2.5">
              {widgets.map((w, i) => {
