...
function VoiceStageInner() {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      <Image src={VOICE_PHOTO} fittingType="fill" alt="" className="absolute inset-0 w-full h-full rounded-l-[24px] rounded-r-none" draggable={false} />
      <div className="absolute inset-0 bg-gradient-to-t from-black/55 via-black/25 to-black/30 rounded-l-[24px] rounded-r-none" />
