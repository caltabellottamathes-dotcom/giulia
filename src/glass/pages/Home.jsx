...
import { PageShell, GlassPanel, GlassButton, SectionHeader, Divider } from "@/glass/components/glass";
...
const NAV = [
  { to: "/glass", label: "Home" },
  { to: "/glass/self", label: "SELF" },
  { to: "/glass/week", label: "Week" },
  { to: "/glass/dagplanning", label: "Dag" },
  { to: "/glass/projecten", label: "Projecten" },
  { to: "/glass/contacten", label: "Contacten" },
  { to: "/glass/taak-details", label: "Taak Details" },
  { to: "/glass/prioriteiten", label: "Matrix" },
  { to: "/glass/notitieblok", label: "Notitieblok" },
  { to: "/glass/instellingen", label: "Instellingen" },
  { to: "/glass/tijd", label: "Tijd" },
  { to: "/glass/archief", label: "Archief" },
  { to: "/glass/focus", label: "Focus" },
  { to: "/glass/briefing", label: "Briefing" },
  { to: "/glass/doelen", label: "Doelen" },
  { to: "/glass/vergader", label: "Vergader" },
  { to: "/glass/inspiratie", label: "Inspiratie" },
  { to: "/glass/taken", label: "Taken" },
  { to: "/glass/statistieken", label: "Statistieken" },
  { to: "/glass/agenda", label: "Agenda" },
  { to: "/glass/modules/taken", label: "Mod Taken" },
  { to: "/glass/modules/email", label: "Email" },
  { to: "/glass/modules/notifications", label: "Notificaties" },
  { to: "/glass/modules/approvals", label: "Goedkeuringen" },
  { to: "/glass/modules/documents", label: "Documenten" },
  { to: "/glass/modules/knowledge", label: "Kennis" },
  { to: "/glass/modules/people", label: "Mensen" },
  { to: "/glass/modules/project-add", label: "Nieuw Project" },
  { to: "/glass/modules/task-archive", label: "Taakarchief" },
  { to: "/glass/modules/task-detail", label: "Taakdetail" },
  { to: "/glass/modules/time-tracker", label: "Tijdtracker" },
  { to: "/glass/modules/week", label: "Weekview" },
  { to: "/glass/modules/whatsapp", label: "WhatsApp" },
];
