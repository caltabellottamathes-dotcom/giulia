...
const NAV = [
  ...
  { to: "/glass/weekplanning", label: "Week" },
  ...
  { to: "/glass/prioriteiten-matrix", label: "Matrix" },
  { to: "/glass/notitieblok", label: "Notitieblok" },
  { to: "/glass/instellingen", label: "Instellingen" },
  { to: "/glass/tijdsregistratie", label: "Tijd" },
  { to: "/glass/archief", label: "Archief" },
  { to: "/glass/focus-modus", label: "Focus" },
  { to: "/glass/dagelijkse-briefing", label: "Briefing" },
  { to: "/glass/doelen-dashboard", label: "Doelen" },
  { to: "/glass/vergader-notities", label: "Vergader" },
  { to: "/glass/inspiratie-bord", label: "Inspiratie" },
  { to: "/glass/takenoverzicht", label: "Taken" },
  { to: "/glass/statistieken", label: "Statistieken" },
  { to: "/glass/agenda-overzicht", label: "Agenda" },
  { to: "/glass/taken", label: "Taken" },
  { to: "/glass/email", label: "Email" },
  { to: "/glass/notifications", label: "Notificaties" },
  { to: "/glass/approvals", label: "Goedkeuringen" },
  { to: "/glass/documents", label: "Documenten" },
  { to: "/glass/knowledge", label: "Kennis" },
  { to: "/glass/people", label: "Mensen" },
  { to: "/glass/project-add", label: "Nieuw Project" },
  { to: "/glass/task-archive", label: "Archief" },
  { to: "/glass/task-detail", label: "Taakdetail" },
  { to: "/glass/time-tracker", label: "Tijd" },
  { to: "/glass/week", label: "Week" },
  { to: "/glass/whatsapp", label: "WhatsApp" },
];
