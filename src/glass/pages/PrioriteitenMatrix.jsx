...
import { PageShell, GlassButton } from "@/glass/components/glass";
  ...
  return (
    <PageShell>
      ...
      <div className="grid grid-cols-[64px_1fr_1fr] grid-rows-[auto_1fr_1fr] gap-2 min-h-[460px]">
        ...
        <p className="text-marble/50 text-[11px] font-medium self-center text-center" style={{ writingMode: "vertical-rl", transform: "rotate(180deg)" }}>Urgent ↓</p>
        <Quad q={QUADS[0]} />
        <Quad q={QUADS[2]} />

        <p className="text-marble/50 text-[11px] font-medium self-center text-center" style={{ writingMode: "vertical-rl", transform: "rotate(180deg)" }}>↑ Niet urgent</p>
        <Quad q={QUADS[1]} />
        <Quad q={QUADS[3]} />
      </div>
    </PageShell>
