...
/**
 * ProjectsWidget — average completion as the hero over a branded photo; each
 * active project is a Gantt-style track. Tactile ± nudges the lead project.
 */
    ...
    <WidgetShell size="2x2" radius="medium" interactive onClick={() => openModule("projects")} className="min-h-[260px]">
      <div className="p-5 flex flex-col h-full">
        ...
        {loading ? (
          ...
          <>
            <BrandPhoto src={IMAGES.walkChairsHigh} className="h-20 rounded-2xl mb-4" overlay="bg-gradient-to-r from-charcoal/85 via-charcoal/40 to-transparent">
