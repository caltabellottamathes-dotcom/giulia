  ...
  return (
    <WidgetShell size="2x2" radius="large" interactive onClick={() => openModule("agenda")} className="min-h-[260px]">
      <div className="flex flex-col h-full">
        <div className="relative h-28 shrink-0 overflow-hidden rounded-b-[24px]">
          ...
          <div className="absolute inset-0 p-5 flex flex-col justify-between">
            ...
            {next ? (
              <div>
                <span className="text-3xl font-display font-semibold tracking-[-0.03em] leading-none text-ivory tabular-nums" style={{ textShadow: "0 2px 14px rgba(0,0,0,0.5)" }}>
              ...
              <div>
                <span className="text-3xl font-display font-semibold text-ivory/85">0</span>
        ...
        <div className="flex-1 px-4 py-3 text-ivory flex flex-col">
          {loading ? (
