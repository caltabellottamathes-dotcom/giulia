  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-24 right-4 lg:bottom-7 lg:right-7 z-30 h-12 w-12 lg:h-14 lg:w-14 rounded-full glass-2 float-shadow flex items-center justify-center text-ivory transition-all duration-300 hover:scale-105 group"
