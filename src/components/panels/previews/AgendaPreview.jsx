...
/** Agenda module paneel — chronologische tijdlijn (naar het ontwerp van
 *  /slick/agenda-overzicht), in GIULIA-glass branding met live Event-data. */
                  ...
                  <div className="ml-[68px] flex flex-col gap-2.5">
                    {items.map((e) => (
                      <div
                        key={e.id}
                        onClick={onOpen}
                        className="group flex items-center gap-3 rounded-2xl border border-white/15 bg-white/[0.06] px-4 py-3 hover:bg-white/10 transition-colors cursor-pointer"
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-ivory/50 text-xs mt-0.5 truncate">
                            {e.location || "Afspraak"}{e.end ? " · tot " + format(new Date(e.end), "HH:mm") : ""}
                          </p>
                        </div>
