...
export default function MonthlyIncomeCounter() {
  ...
  return (
    <div className="relative w-full rounded-[18px] overflow-hidden" style={{ boxShadow: "-16px 16px 40px -16px rgba(0,0,0,0.30)" }}>
      ...
      <div className="absolute inset-0" style={{ background: "linear-gradient(to right, rgba(20,22,26,0.82), rgba(20,22,26,0.58) 55%, rgba(20,22,26,0.38))" }} />
      <div className="relative p-5 flex items-center justify-between gap-4" style={{ color: "#f4f4f0", textShadow: "0 1px 8px rgba(0,0,0,0.45)" }}>
