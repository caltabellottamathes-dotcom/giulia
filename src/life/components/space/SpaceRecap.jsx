  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      <section className="mt-6">
        ...
        <h2 className="leading-[0.98] tracking-[-0.03em] text-editorial-blue font-medium [font-family:'JetBrains_Mono',_monospace] text-[32px] sm:text-[32px] my-4 px-1">{title}</h2>
